...
if (puritureOpen != null) {
    ...
    puritureOpen.addEventListener("click", function (e) {
        ...
        puritureMenu.classList.toggle("zIndex");
    })
...
let selectWay = document.querySelector(".selcet-way");
if (selectWay != null) {
    ...
    function selcetW() {
        ...
        console.log(ways)
        let v = selectWay.value;
    
        selectWay.setAttribute("data-open", `${v}-input`);
    
        let d = selectWay.getAttribute("data-open");
        console.log(v);
        console.log(d);

        for (var i = 0; i < ways.length; i++) {
            ways[i].classList.add("dis-none");
            ways[i].classList.remove("dis-flex")
        }
        document.getElementById(`${d}`).classList.remove("dis-none")
        document.getElementById(`${d}`).classList.add("dis-flex")
...
if (colorOptionOpen != null) {
    colorOptionOpen.addEventListener("click", function (el) {
        ...
        colorOption.classList.toggle("zIndex");
